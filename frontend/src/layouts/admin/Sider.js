                    ...
                    <>
                        ...
                        <Row style={{ width: '100%', padding: 0 }}>
                            <Col span={24} align='center' style={{ padding: 0 }}>
                                <Flex justify='center' align='center' style={{ width: '100%', height: 60, textAlign: 'center' }} >
                            ...
                            <Col span={24} align='center' style={{ padding: 0 }}>
                                <Flex justify='center' align='center' style={{ width: '100%', minHeight: 60 }} gap={4}>
                                    <Avatar icon={<UserOutlined />}
                                        ...
                                        size={'small'} style={{ minWidth: 36, minHeight: 36, marginLeft: 24 }} />
