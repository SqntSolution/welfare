...
const NoticeRegistration = () => {
    ...
    const onFinish = async (values) => {
        ...
        if (await validationCheck(formData)) pushData('post', 'notice', formData, () => navigate(-1));
    }
    ...
    const mindleForm = () => {
        return (
            <>
                ...
                <Form.Item label='공지유형' name='noticeType'
                    style={{ marginBottom: 8 }}
                    rules={[
                        {
                            required: !readonly,
                ...
                </Form.Item>
                {
                    (id && id !== 'new')
                        ?
                        <Form.Item label='작성자' name='createUserNm' style={{ marginBottom: 8 }}>
                ...
                <Form.Item label='내용' name='contents' disabled={readonly} style={{ marginBottom: 8 }}>
                    <TheCkeditor
                        data={textData}
                        setData={setTextData}
                        readonly={readonly}
        ...
        <Spin spinning={loading}>
            ...
            <InnerAdminDiv>
                <Form
                    ...
                    <Typography.Title level={5} style={{ marginBottom: 24, marginTop: 0 }}>공지사항</Typography.Title>
                    {
                        mindleForm()
                    }
                    {
