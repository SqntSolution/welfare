...
*/
export const DynamicArea = ({ postDetails, setDyanmicDetails }) => {
    ...
    const addMenuOptions = [
        {
            key: '1',
            label: <span onClick={() => addComponent({ detailsType: 'editor', contents: null })} style={{ display: 'inline-block', width: '100%' }} >Editor 추가</span>,
            icon: <EditOutlined />,
        },
        {
            key: '2',
            label: <span onClick={() => addComponent({ detailsType: 'pdf', path: null })} style={{ display: 'inline-block', width: '100%' }} >PDF 추가</span>,
    ...
    return (
        <>
                ...
                components?.map((elem, idx) => {
                    ...
                    return (
                        <StyledCard
                            ...
                            extra={<Button style={{ fontSize: 14 }} onClick={(e) => { remove(elem.key2); e.stopPropagation() }}>삭제</Button>}
                            style={{
                                width: '100%',
                                maring: '12px 0px',
            ...
            <Col span={24} align='center'>
                ...
                >
                    <StyledButtonAdd>
                        <PlusOutlined style={{ fontSize: 38, width: '100%', color: 'rgba(0, 0, 0, 0.85)', margin: 0, padding: 0 }} />
                        <p style={{ fontSize: 16, margin: "16px 0 0 0", color: 'rgba(0, 0, 0, 0.75)' }}>추가</p>
                    </StyledButtonAdd>
                </Dropdown>
            </Col>
        </>
